...
export class MatIV {
	...
	rotate = (mat: Float32Array, angle: number, axis: Float32Array, dest: Float32Array): Float32Array | null => {
    ...
    orthographic = (top: number, bottom: number, right: number, left: number, far: number, near: number, dest: Float32Array): Float32Array => {
        dest[0] = 2 / (right-left);
		dest[1] = 0;
		dest[2] = 0;
